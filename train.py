...
config = Config({
    ...
    'db_path': 'C:/Users/User/Desktop/1_dacon/SAMSUNG/Image Quality Assessment/MUSIQ-main/data/train',      # root path of database
    # 'txt_file_name': './IQA_list/koniq-10k.txt',                # list of images in the database
    'txt_file_name': 'C:/Users/User/Desktop/1_dacon/SAMSUNG/Image Quality Assessment/MUSIQ-main/IQA_list/koniq-10k.txt',                # list of images in the database
